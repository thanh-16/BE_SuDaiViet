            ...
            try
            {
                var seedBaseDataSql = @"
                    ...
                    VALUES
                        ...
                        ('potion_hp_small', 'Hồi Huyết Đan (Nhỏ)', 'Hồi phục 30% sinh lực tức thì trong chiến đấu.', 100, 0, 0, 'Consumable', '{""slot"": ""potion"", ""effect"": ""heal_pct"", ""value"": 0.30, ""duration"": 0.0, ""icon_path"": ""res://assets/sprites/items/potion_hp_small.png""}'),
                        ('potion_hp_large', 'Đại Hoàn Đan (Lớn)', 'Hồi phục 100% sinh lực tối đa và giải trừ mọi suy nhược.', 300, 5, 0, 'Consumable', '{""slot"": ""potion"", ""effect"": ""heal_full"", ""value"": 1.00, ""duration"": 0.0, ""icon_path"": ""res://assets/sprites/items/potion_hp_large.png""}'),
                        ('potion_rage', 'Cửu Chuyển Nộ Đan', 'Nạp đầy 100% Nộ Khí giúp tung Tất Sát Cuồng Nộ ngay tức khắc.', 250, 10, 0, 'Consumable', '{""slot"": ""potion"", ""effect"": ""rage_max"", ""value"": 100.0, ""duration"": 0.0, ""icon_path"": ""res://assets/sprites/items/potion_rage.png""}'),
                        ('potion_shield', 'Kim Cương Hộ Thể Đan', 'Lá chắn kim cương bảo hộ, miễn nhiễm 100% sát thương trong 15 giây.', 500, 20, 0, 'Consumable', '{""slot"": ""potion"", ""effect"": ""shield_invincible"", ""value"": 1.0, ""duration"": 15.0, ""icon_path"": ""res://assets/sprites/items/potion_shield.png""}'),
                        ('potion_buff_attack', 'Hổ Tướng Cuồng Dược', 'Tăng 50% sát thương chí mạng và tốc độ đánh trong 45 giây.', 400, 15, 0, 'Consumable', '{""slot"": ""potion"", ""effect"": ""buff_attack"", ""value"": 0.50, ""duration"": 45.0, ""icon_path"": ""res://assets/sprites/items/potion_buff_attack.png""}'),
                        ('potion_revive', 'Cửu Mệnh Phục Sinh Đan', 'Hồi sinh tại chỗ với 100% Sinh lực & Nộ Khí khi gục ngã trong ải.', 1000, 50, 0, 'Consumable', '{""slot"": ""potion"", ""effect"": ""revive_full"", ""value"": 1.0, ""duration"": 0.0, ""icon_path"": ""res://assets/sprites/items/potion_revive.png""}'),
                        ('frame_pioneer_gold', 'Khung Viền Hoàng Kim Tiên Phong', 'Khung viền rồng vàng thần thoại độc quyền đầu game dành cho nghĩa sĩ tiên phong. Tỏa hào quang rực rỡ và vinh danh bậc đế vương trên Top Server.', 0, 500, 0, 'Cosmetic', '{""slot"": ""frame"", ""effect"": ""pioneer_gold_aura"", ""value"": 1.0, ""duration"": 0.0, ""icon_path"": ""res://assets/sprites/items/frame_pioneer_gold.png""}')
                    ON CONFLICT (id) DO UPDATE
                    SET name = EXCLUDED.name, description = EXCLUDED.description, price_gold = EXCLUDED.price_gold, price_gem = EXCLUDED.price_gem, attributes = EXCLUDED.attributes;
